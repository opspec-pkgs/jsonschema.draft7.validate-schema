[![build](https://github.com/opspec-pkgs/jsonschema.draft7.validate-schema/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/jsonschema.draft7.validate-schema/actions/workflows/build.yml)
